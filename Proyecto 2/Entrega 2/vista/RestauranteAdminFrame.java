...
public class RestauranteAdminFrame extends FrameBaseInfo{
	...
	protected void setPanelInfo() {
        ...
        //Creacion del recuadro para añadir producto menu a la habitacion
  		...
  		JPanel botonesHabitacion = new JPanel(new GridLayout(2,1,0,10));
  		botonesHabitacion.setBackground(Color.decode("#accaf2"));
  		
  		JButton CargarAHabitacion = new BotonRedondeado("Cargar a la habitación​", 25, 100, 30, Color.white);
  		...
  		JButton pagarAhora = new BotonRedondeado("Pagar ahora​", 25, 100, 30, Color.white);
  		...
  		habitacion.add(botonesHabitacion);
